...
export function IaArcade() {
  ...
  // El arcade vive dentro de la landing, así que no puede quedarse corriendo
  // a 60fps mientras alguien lee el resto de la página.
  useEffect(() => {
    ...
    <div ref={containerRef} className="text-white">
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-5xl">IA Arcade</h2>
          <p className="mx-auto mt-3 max-w-2xl text-base text-gray-400 sm:text-lg">
            Tres juegos construidos con inteligencia artificial. Juégalos aquí mismo.
          </p>
        </motion.div>

        <div className="mt-6 grid gap-3 lg:grid-cols-[280px_1fr] lg:items-center">
          ...
          <section className="min-h-0 rounded-[1.5rem] border border-white/15 bg-white/[.06] p-2 shadow-2xl backdrop-blur sm:rounded-[2rem] sm:p-5">
            ...
            <canvas
              ...
              className="mx-auto aspect-[8/9] h-auto w-full max-w-[360px] touch-none rounded-2xl border border-emerald-300/20 bg-[#07110b] shadow-[0_0_40px_rgba(16,185,129,.18)] sm:rounded-3xl"
        ...
        <button
          type="button"
          onClick={openContact}
          className="mt-4 inline-flex h-12 shrink-0 items-center justify-center gap-2 rounded-2xl border border-emerald-300/30 bg-emerald-300 px-4 text-center text-sm font-bold leading-tight text-black shadow-[0_0_25px_rgba(16,185,129,.24)] transition active:scale-95"
        >
